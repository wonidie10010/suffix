...
METHOD_NAME = "suffix_reoptimization_v1.2.1"
...
@dataclass
class SuffixReoptimizationV121Config:
    enabled: bool = False
...
def _log_result(f, result):
    ...
    log_kv(f, "manifold_enabled", result.get("manifold_enabled"))
    log_kv(f, "manifold_weight", result.get("manifold_weight"))
    log_kv(f, "manifold_updates", result.get("manifold_updates"))
    ...
    for event in result.get("events", []):
        if event.get("triggered"):
            ...
            log_line(f, (
                ...
                "hidden_loss={} -> {}, prox_loss={} -> {}, range_loss={} -> {}, "
                "loss={} -> {}, manifold_enabled={}, manifold_updates={}, "
                ...
                optimization.get("manifold_enabled"),
...
def run_suffix_reoptimization_v1_2_1(model, embed_layer, optimized_embedding, target_hidden_state,
...
SuffixReoptimizationConfig = SuffixReoptimizationV121Config
run_suffix_reoptimization = run_suffix_reoptimization_v1_2_1
