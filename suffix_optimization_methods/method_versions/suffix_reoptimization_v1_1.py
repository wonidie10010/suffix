...
def _log_result(f, result):
    ...
    for event in result.get("events", []):
        if event.get("triggered"):
            ...
            log_line(f, (
                "  suffix_round {}/{}: anomaly_pos={}, reasons={}, weight_mode={}, "
...
def run_suffix_reoptimization_v1_1(model, embed_layer, optimized_embedding, target_hidden_state,
...
SuffixReoptimizationConfig = SuffixReoptimizationV11Config
run_suffix_reoptimization = run_suffix_reoptimization_v1_1
